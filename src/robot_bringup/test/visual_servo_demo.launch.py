...
"""
============================================================================
Visual Servo Demo Launch File (No Hardware)
============================================================================

하드웨어 없이 Visual Servoing 테스트용 런치 파일
- Fake controllers 사용
- MoveIt Servo + Visual Servo Controller
...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument("servo_gain", default_value="1.0"),
    ]
    ...
    return LaunchDescription(
        declared_arguments + [
            ...
            move_group_node,
            # Give servo_node more time to initialize and advertise services
            TimerAction(period=6.0, actions=[servo_node]),
            TimerAction(period=8.0, actions=[visual_servo_controller]),
            rviz_node,
        ]
    )
