#!/usr/bin/env python3
"""
MoveIt + Real Hardware Launch File
- MyActuator RMD motors via CAN
...
def generate_launch_description():
    ...
    # Robot description - using arm_gripper_hardware.xacro for real gripper
    ...
    # Planning pipeline configuration - flat parameters for proper loading
    # NOTE: In MoveIt2 Humble, AddTimeOptimalParameterization is a request adapter, not response adapter
    ...
    trajectory_execution = {
        ...
        "trajectory_execution.allowed_start_tolerance": 0.0,  # 0 = 체크 비활성화
    ...
    delay_jsb = RegisterEventHandler(
        OnProcessExit(
            ...
            on_exit=[],  # ros2_control_node doesn't exit, use timer instead
        )
    )
