...
"""
============================================================================
Mobile Manipulator MoveIt Launch File (USBCAN Version)
============================================================================

USBCAN 기반 통합 하드웨어 런치 파일
- Arm: MyActuator RMD motors via USBCAN-UC12 (libusb)
...
- baudrate: CAN 통신 속도 (default: 1000000)
