...
For **building and installing this package with ROS 2** open a new terminal on the top-level folder of your Colcon workspace (e.g. `mobile_manipulator_ws`) and execute the following command:
