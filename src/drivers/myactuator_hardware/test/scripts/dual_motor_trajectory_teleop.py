...
class DualMotorTrajectoryTeleop(Node):
    def __init__(self):
        super().__init__('dual_motor_trajectory_teleop')
        ...
        self.get_logger().info('Dual Motor Trajectory Teleop Node Started')
        self.print_instructions()
        
    def print_instructions(self):
        print("\n" + "="*50)
        print("DUAL MOTOR TRAJECTORY TELEOP CONTROL")
        print("="*50)
    ...
    def send_trajectory(self):
        ...
        point.positions = [self.joint1_pos, self.joint2_pos]
        point.velocities = [0.0, 0.0]
        point.time_from_start = Duration(sec=int(self.move_time), nanosec=int((self.move_time % 1) * 1e9))
...
def main():
    ...
    teleop = DualMotorTrajectoryTeleop()
